<!--Code on this page for bar chart from https://github.com/djaxho/pure-vue-chart-->
<template>
  <svg
    class="bar-graph"
    :width="fullSvgWidth"
  ...
  computed: {
    ...
    xAxisHeight() {
      return this.showYAxis
        ? this.labelHeight + 20
        : this.labelHeight + this.extraBottomHeightForYAxisLabel + this.extraTopHeightForYAxisLabel + 20;
    },
    fullSvgWidth() {
      return this.width;
    },
